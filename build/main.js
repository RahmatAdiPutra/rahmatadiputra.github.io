...
BiodataPage = BiodataPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-biodata',template:/*ion-inline-start:"/home/falconcyber/workdir/myionic/portofolio/src/pages/biodata/biodata.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Biodata</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n      <ion-card-title>\n          Biodata<hr>\n        </ion-card-title>\n        <ion-grid>\n          <ion-row>\n            <ion-col col-5>Nama</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Rahmat Adi Putra</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Tempat, Tanggal Lahir</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Palu, 11 Oktober 1995</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Alamat</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Babadan</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Email</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>rahmat.adi.putra21@gmail.com</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>No. Telp</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>+6282344846769</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Jenis Kelamin</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Laki - laki</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Agama</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Islam</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Status</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Belum Nikah</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Tinggi/Berat Badan</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>169/58</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Golongan Darah</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>AB</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>Kewarganegaraan</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Indonesia</ion-col>\n          </ion-row>\n        </ion-grid>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n<ion-footer>\n  <ion-toolbar color="primary">\n    <div text-center>\n      <b style="color: white;">Curriculum Vitae</b>\n    </div>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/home/falconcyber/workdir/myionic/portofolio/src/pages/biodata/biodata.html"*/
    }),
...
RiwayatPage = RiwayatPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-riwayat',template:/*ion-inline-start:"/home/falconcyber/workdir/myionic/portofolio/src/pages/riwayat/riwayat.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Riwayat Pendidikan</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n      <ion-card-title>\n          Riwayat Pendidikan<hr>\n        </ion-card-title>\n        <ion-grid>\n          <ion-row>\n            <ion-col col-5>2001 - 2008</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>SDN 8 Mamboro, Kota Palu, Sulawesi Tengah</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>2008 - 2011</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>SMPN 18 Palu, Kota Palu, Sulawesi Tengah</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>2011 - 2014</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>SMKN 6 Palu, Kota Palu, Sulawesi Tengah</ion-col>\n          </ion-row>\n          <ion-row>\n            <ion-col col-5>2014 - Sekarang</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Program Studi Sistem Informasi STMIK AKAKOM Yogyakarta</ion-col>\n          </ion-row>\n        </ion-grid>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n<ion-footer>\n  <ion-toolbar color="primary">\n    <div text-center>\n      <b style="color: white;">Curriculum Vitae</b>\n    </div>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/home/falconcyber/workdir/myionic/portofolio/src/pages/riwayat/riwayat.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
], RiwayatPage);
...
PengalamanPage = PengalamanPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-pengalaman',template:/*ion-inline-start:"/home/falconcyber/workdir/myionic/portofolio/src/pages/pengalaman/pengalaman.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Pengalaman Kerja / Organisasi</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n      <ion-card-title>\n          Pengalaman Kerja / Organisasi<hr>\n        </ion-card-title>\n        <ion-grid>\n        <ion-row>\n            <ion-col col-5>2012 - 2012</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Praktek Kerja Lapangan di STMIK AKAKOM Yogyakrta</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>2015 - Sekarang</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Anggota UKM Informatika dan Komputer STMIK AKAKOM Yogyakrta</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>2016 - 2017</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Departemen Humas UKM Informatika dan Komputer STMIK AKAKOM Yogyakrta</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>2017 - 2018</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Dewan Penasehat Organisasi UKM Informatika dan Komputer STMIK AKAKOM Yogyakrta</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>01 Agustus 2017 - 31 Agustus 2017</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>Praktek Kerja Lapangan di PT. Solution 247 Cabang Yogyakarta</ion-col>\n        </ion-row>\n        </ion-grid>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n<ion-footer>\n  <ion-toolbar color="primary">\n    <div text-center>\n      <b style="color: white;">Curriculum Vitae</b>\n    </div>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/home/falconcyber/workdir/myionic/portofolio/src/pages/pengalaman/pengalaman.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
], PengalamanPage);
...
SkillPage = SkillPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-skill',template:/*ion-inline-start:"/home/falconcyber/workdir/myionic/portofolio/src/pages/skill/skill.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Skills</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n      <ion-card-title>\n          Skills<hr>\n        </ion-card-title>\n        <ion-grid>\n        <ion-row>\n            <ion-col col-5>PHP</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>10%</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Java</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>5%</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>MySQL</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>30%</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>MongoDB</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>5%</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Framework Yii</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>7%</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Framework CodeIgniter</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>5%</ion-col>\n        </ion-row><ion-row>\n            <ion-col col-5>Framework Ionic</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>5%</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Node Js</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>5%</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Android Studio</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>1%</ion-col>\n        </ion-row>\n        </ion-grid>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n<ion-footer>\n  <ion-toolbar color="primary">\n    <div text-center>\n      <b style="color: white;">Curriculum Vitae</b>\n    </div>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/home/falconcyber/workdir/myionic/portofolio/src/pages/skill/skill.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
], SkillPage);
...
GaleriPage = GaleriPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-galeri',template:/*ion-inline-start:"/home/falconcyber/workdir/myionic/portofolio/src/pages/galeri/galeri.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Galeri</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n      <ion-card-title>\n          Galeri Foto<hr>\n        </ion-card-title>\n        <ion-grid>\n        <ion-row>\n            <ion-col col-4></ion-col>\n            <ion-col col-4></ion-col>\n            <ion-col col-4></ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-4></ion-col>\n            <ion-col col-4></ion-col>\n            <ion-col col-4></ion-col>\n        </ion-row>\n        </ion-grid>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n<ion-footer>\n  <ion-toolbar color="primary">\n    <div text-center>\n      <b style="color: white;">Curriculum Vitae</b>\n    </div>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/home/falconcyber/workdir/myionic/portofolio/src/pages/galeri/galeri.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
], GaleriPage);
...
ProjectPage = ProjectPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-project',template:/*ion-inline-start:"/home/falconcyber/workdir/myionic/portofolio/src/pages/project/project.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Projects</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n      <ion-card-title>\n          Projects<hr>\n        </ion-card-title>\n        <ion-grid>\n        <ion-row>\n            <ion-col col-5>Sistem Informasi Presensi</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>localhost</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Sistem Informasi Keanggotaan UKM Informatika & Komputer</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>ukm-ik.akakom.ac.id/keanggotaan</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Portal UKM Informatika & Komputer</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>ukm-ik.akakom.ac.id/account</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Apps Info Kampus AKAKOM</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>bit.ly/AppMobileAkakom</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Apps Mobile AKAKOM</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>https://github.com/RahmatAdiPutra/TugasAkhirMobile</ion-col>\n        </ion-row>\n        <ion-row>\n            <ion-col col-5>Document Management Sistem</ion-col>\n            <ion-col col-1>:</ion-col>\n            <ion-col col-6>localhost</ion-col>\n        </ion-row>\n        </ion-grid>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n<ion-footer>\n  <ion-toolbar color="primary">\n    <div text-center>\n      <b style="color: white;">Curriculum Vitae</b>\n    </div>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/home/falconcyber/workdir/myionic/portofolio/src/pages/project/project.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
], ProjectPage);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/falconcyber/workdir/myionic/portofolio/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/home/falconcyber/workdir/myionic/portofolio/src/app/app.html"*/
    }),
